...
class CastListAdapter (var casts: ArrayList<Cast>): RecyclerView.Adapter<CastListAdapter.MovieViewHolder>() {
    ...
    inner class MovieViewHolder(view: View): RecyclerView.ViewHolder(view){
        ...
        fun bind(cast: Cast){
            name.text=cast.name
            val s = "https://image.tmdb.org/t/p/w342${cast.profile_path}"  //is how you fetch a poster of a movie from TMDb
